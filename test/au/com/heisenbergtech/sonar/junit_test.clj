(ns au.com.heisenbergtech.sonar.junit-test
  (:require [clojure.test :refer [deftest is testing]]
            [clojure.test.check.clojure-test :refer [defspec]]
            [clojure.test.check.generators :as gen]
            [clojure.test.check.properties :as prop]
            [au.com.heisenbergtech.sonar.junit :as junit]))
...
(deftest namespace-maps-to-its-source-path
  (testing "dots become directories, hyphens become underscores"
    ...
    (is (= "au/com/heisenbergtech/sonar/parse_test" (junit/ns->path "au.com.heisenbergtech.sonar.parse-test")))))
