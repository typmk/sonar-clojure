(ns net.typemark.sonar.bootstrap-test
...
(defn- bootstrap ^Plugin []
  (-> (Class/forName "net.typemark.sonar.ClojurePluginBootstrap")
...
(deftest the-entry-point-is-java-not-clojure
  (testing "loading a gen-class artifact is what triggers Clojure's runtime,
    ...
    (let [c (Class/forName "net.typemark.sonar.ClojurePluginBootstrap")]
