(ns au.com.heisenbergtech.sonar.gen
  ...
  keywords, which `au.com.heisenbergtech.sonar.rules` then translated back through four
...
(defn write-linters!
  "Emit resources/au/com/heisenbergtech/sonar/linters.edn from clj-kondo's default config."
  [_]
